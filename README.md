...
3. a page to show information about a single channel including:
  ...
  * a button to add the channel (if the user does not already subscribe to this channel)
  * a button to remove the channel (if the user already subscribes to this channel)
  * the channel's price
